...
Consider using Travis CI (continuous integration) (which I haven't done yet). Every time code is committed/pushed to Github, the R CMD Check and unit tests will automatically run.
